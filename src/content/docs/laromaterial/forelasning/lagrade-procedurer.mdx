---
title: "⚠️ Lagrade procedurer och programmera i databasen"
...
⚠️ Du kan själv bläddra igenom [de HTML slides som används i presentationen](kursmaterial/databas/forelasning/v1/f05-procedurer-och-trigger/slide-procedurer.html).
...
* Artikel om "[Lagrade procedurer i databas](https://dbwebb.se/kunskap/lagrade-procedurer-i-databas)".
