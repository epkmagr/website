---
title: "⚠️ Index och prestanda i databasen"
...
⚠️ Du kan själv bläddra igenom [de HTML slides som används i presentationen](kursmaterial/databas/forelasning/v1/f06-index-och-prestanda/slide.html).
...
* Artikel om "[Index och prestanda i MySQL](https://dbwebb.se/kunskap/index-och-prestanda-i-mysql)".
