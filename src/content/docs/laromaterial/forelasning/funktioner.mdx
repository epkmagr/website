---
title: "⚠️ Funktioner och programmera i databasen"
...
⚠️ Du kan själv bläddra igenom [de HTML slides som används i presentationen](kursmaterial/databas/forelasning/v1/f06-funktioner/slide.html).
...
* Artikel om "[Egendefinierade funktioner i databas](https://dbwebb.se/kunskap/egen-definierade-funktioner-i-databas)".
